                ...
                child: currentUser == null
                    ...
                    : StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          // Prepare data for chart (chronological order)
                          final chartDocs = docs.toList().reversed.toList();
                          List<FlSpot> spots = [];
                          for (int i = 0; i < chartDocs.length; i++) {
                            final data = chartDocs[i].data() as Map<String, dynamic>;
                            final level = data['stress_level']?.toString() ?? '';
                              ...
                              Container(
                                ...
                                child: LineChart(
                                  LineChartData(
                                        ...
                                        sideTitles: SideTitles(
                                          ...
                                          getTitlesWidget: (value, meta) {
                                            if (value.toInt() >= 0 && value.toInt() < chartDocs.length) {
                                              final data = chartDocs[value.toInt()].data() as Map<String, dynamic>;
                                    ...
                                    minX: 0,
                                    maxX: (chartDocs.length - 1).toDouble() > 0 ? (chartDocs.length - 1).toDouble() : 1,
                                    minY: 0,
                                    maxY: 3.5,
                                    lineBarsData: [
                                      LineChartBarData(
                              ...
                              Expanded(
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final displayLevel = level.isNotEmpty 
